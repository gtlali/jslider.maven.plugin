...
public class myjslider extends JSlider implements ChangeListener {
	 ...
	 * @param val
	 *            The init value for the slider.
	 */
	public myjslider(double min, double max, double val) {
		super();
		DOUBLE_FACTOR = 100.0;
	...
	public myjslider(double min, double max, double val, double factor) {
		super();
	 ...
	 * 
	 * @param s
	 *            The specified title for the slider.
	 */
	 ...
	 * 
	 * @param max
	 *            The value which needs to be set as maximum value for the
	 *            slider.
	 */
	 ...
	 * 
	 * @param min
	 *            The value which needs to be set as minimum value for the
	 *            slider.
	 */
	 ...
	 * 
	 * @param val
	 *            The value which needs to be set as current value for the
	 *            slider.
	 */
	 ...
	 */
	class jsliderUI extends BasicSliderUI implements MouseMotionListener,
			MouseListener {
		 ...
		 * 
		 * @param slider
		 *            The specified {@link myjslider}.
		 */
		public jsliderUI(myjslider slider) {
			super(slider);
		 ...
		 * 
		 * @param me
		 *            The mouse event of slider moving.
		 */
