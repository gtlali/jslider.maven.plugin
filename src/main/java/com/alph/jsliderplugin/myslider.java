...
@Named
@Singleton
public class myslider implements imyslider {
	private JLabel l; 	
	 public void buildGUI()
	  {		
	    myjslider slider = new myjslider(0, 600, 1);
	    System.out.print("Start -Insider myslider class" );
	    slider.setMajorTickSpacing(1000);
	    slider.setMinorTickSpacing(100);
	    slider.setPaintTicks(true);
	    System.out.print("0- Insider myslider class\n" );
	    ...
	    System.out.print("1- Insider myslider class\n" );
	    JFrame f = new JFrame();
	    // create label 
	    l = new JLabel();   
	    ...
	    f.setVisible(true);
	    System.out.print("2- Insider myslider class\n" );
